/**
 * Professional STM32F030F4 LED Pattern Player - Upload Bridge Template
 * 
 * Full professional-grade pattern player with all advanced features
 * Optimized for STM32F030F4P6 with 16KB flash and 4KB RAM
...
#define MAX_LEDS 180  // Optimized for STM32F030F4P6 memory
...
void delay_ms(uint32_t ms) {
    // Simple delay loop for STM32F030 at 72MHz
