"""
Integration Test Configuration - Dialog mocking and common fixtures

Provides dialog mocking to prevent QMessageBox from blocking tests.
"""
...
def qapp():
    """Ensure QApplication exists for integration tests"""
...
def mock_dialogs():
    """Auto-mock all dialogs to prevent blocking in tests"""
